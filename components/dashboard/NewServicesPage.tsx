...
const services = [
  {
    ...
    description: "Crie bots humanizados que funcionam como um funcionário que nunca dorme, atendendo seus clientes 24h por dia, agendando serviços e qualificando leads automaticamente. Garanta que nenhuma oportunidade escape, mesmo fora do horário comercial.",
    benefits: [
  ...
  },
  {
    ...
    description: "Chega de passar vários links ou sentir que sua bio não reflete seu profissionalismo. Tenha uma bio otimizada e um link personalizado que reúne todos os seus canais e informações importantes em um único local, com banners e design que impressionam.",
    benefits: [
      "Mais Conversões e Engajamento",
      "Navegação Intuitiva e Fácil",
      "Imagem Profissional e Coesa",
    ],
  ...
  },
  {
    ...
    benefits: [
      "Destaque e Reconhecimento no Mercado",
...
const NewServicesPage: React.FC = () => {
    ...
    const handleServiceClick = (serviceTitle: string) => {
        openChat(`Olá! Vi o serviço "${serviceTitle}" no meu painel e gostaria de saber mais.`);
    }

    return (
        <AnimateOnScroll>
            <div>
                <h2 className="text-3xl font-bold text-white mb-4">Explore Novos Serviços</h2>
                <p className="text-lg text-gray-400 max-w-2xl mb-8">
                    Pronto para o próximo passo? Veja outras soluções que podem impulsionar ainda mais seu negócio.
                </p>
