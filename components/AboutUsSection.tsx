            ...
            <div className="md:w-1/2 text-center">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="mt-3">
                    <h3 className="text-white font-semibold text-lg">Tatiane Moraes</h3>
                    <p className="text-gray-400 text-sm">Estrategista de Automação</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="mt-3">
                    <h3 className="text-white font-semibold text-lg">Glauco Silveira</h3>
                    <p className="text-gray-400 text-sm">Designer de Experiência do Cliente</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="relative inline-block avatar-gradient">
                    ...
                    <img
                      src="/duda.jpeg"
                      alt="Foto adicional da equipe da Caixa Criativa"
                      className="relative w-48 h-48 rounded-full object-cover shadow-lg border-4 avatar-img"
                      loading="lazy"
                      decoding="async"
                    />
                  ...
                  <div className="mt-3">
                    <h3 className="text-white font-semibold text-lg">Maria Eduarda</h3>
                    <p className="text-gray-400 text-sm">Estrategista Comercial</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="mt-3">
                    <h3 className="text-white font-semibold text-lg">Marcela Bacelar</h3>
                    <p className="text-gray-400 text-sm">Estrategista de Sucesso do Cliente</p>
                  </div>
                </div>
              </div>
            </div>
