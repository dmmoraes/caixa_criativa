      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {sectors.map((sector, index) => (
            <AnimateOnScroll key={index} style={{ transitionDelay: `${index * 100}ms` }}>
              <div className="clay-card p-8 text-center group flex flex-col h-full">
                <div
                  className={`w-20 h-20 mx-auto mb-6 rounded-3xl bg-gradient-to-br ${sector.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform flex-shrink-0`}
                >
        ...
        <AnimateOnScroll className="text-center mt-16">
          ...
          <p className="text-gray-600 mt-2">
            Seja um dos nossos primeiros casos de sucesso e ganhe um bônus especial!
          </p>
        </AnimateOnScroll>
      </div>
    </section>
