...
const quizSteps = [
  // Step 0: Main Goal
  {
    ...
    options: [
      ...
      {
        text: 'Parecer Mais Profissional',
  ...
  // Step 1: Sales Challenge
  {
    ...
    options: [
      {
        text: 'Demoro para responder e perco o cliente',
        recommendation:
          'Nossa Automação de Atendimento responde a todos instantaneamente, 24/7. Chega de perder vendas por demora!',
      },
      {
        text: 'Meu site/perfil não converte visitantes',
        recommendation:
          'Criamos Sites e Landing Pages otimizados para atrair e converter visitantes. Vamos colocar sua empresa no mapa digital!',
      },
      {
        text: 'Não consigo qualificar quem tem real interesse',
        recommendation:
          'Com um bot inteligente, você qualifica leads automaticamente, focando apenas em quem está pronto para comprar.',
      },
    ],
  },
  // Step 2: Time Challenge
  {
    ...
    options: [
      {
        text: 'Responder as mesmas perguntas sempre',
        recommendation:
          'Um chatbot com FAQ interativo resolve isso. Seus clientes tiram dúvidas sozinhos, e você foca no que importa.',
      },
      {
        text: 'Agendar horários e confirmar manualmente',
        recommendation:
          'Com um bot, seus clientes agendam horários sozinhos, e sua agenda fica sempre organizada e sem conflitos.',
      },
      {
        text: 'Coletar informações iniciais dos clientes',
        recommendation:
          'Deixe que um bot colete os dados e necessidades dos seus clientes, entregando tudo organizado para você.',
      },
    ],
  },
  // Step 3: Professionalism Challenge
  {
    ...
    options: [
      {
        text: 'Minha logo e posts não têm um padrão',
        recommendation:
          'Uma Identidade Visual forte e coesa transmite confiança. Vamos criar uma marca que seus clientes não esquecem.',
      },
      {
        text: 'Meu perfil do Instagram parece amador',
        recommendation:
          'Uma Bio otimizada e um Link na Bio profissional transformam seu perfil numa máquina de conversão. Vamos começar?',
      },
      {
        text: "Não tenho um 'lugar oficial' na internet",
        recommendation:
          'Um site profissional é sua vitrine 24h. Ele centraliza suas informações e passa credibilidade para fechar mais negócios.',
      },
    ],
  },
];
